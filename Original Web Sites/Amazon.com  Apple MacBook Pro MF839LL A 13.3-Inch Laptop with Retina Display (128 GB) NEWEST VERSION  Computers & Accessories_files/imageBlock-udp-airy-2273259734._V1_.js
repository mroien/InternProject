...
}var instance=Airy.embed({parentElement:holder[0],streamingUrls:videoHash.url,contentId:videoHash.mediaObjectId,contentMinAge:Number(videoHash.minimumAge||"")||0,contentTitle:videoHash.title,swfUrl:serverSideConfig.swfUrl,foresterMetadataParams:foresterMetadataParams,backgroundColor:"transparent",flashParams:{wmode:"transparent"},slateImages:{preloadSlate:videoHash.slateUrl,postMediaSlate:videoHash.slateUrl},videoAds:serverSideConfig.videoAds});
...
}if(options.thumbExperimentEnabledValue!==1){data.thumb=options.staticImages.videoThumbIcon;
...
}A.trigger("image-block-thumbnail-selected",eventData);
