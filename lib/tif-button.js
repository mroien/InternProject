...
$(document).ready(function() {
		jQuery("#price .cart-button").after('<a href="Save on Samsung -- $299.99 at bestbuy.com - TrackIf.html"><input id="tif-button" type="button" /><div id="panel"><img src="lib/mock/samsung.PNG" rel="#watch" class="display-Image"/></a></div>');
...
// Amazon
$(document).ready(function() {
		jQuery(".a-box span.a-button-text").after('<a href="https://trackif.com/domains/amazon.com/552c48dc326b9d231b6eb8a9/Apple-MacBook-Pro-MF839LL-A-13-3-Inch-Laptop-with"><input id="tif-button" type="button" /><div id="panel"><img src="lib/mock/macbook.PNG" rel="#watch" class="display-Image"/></a></div>');
		jQuery("#tif-button, #panel").mouseenter(function() {
			$("#panel").stop().show("fold", 1000);
		}).mouseleave(function() {
			$('#panel').stop().slideUp();
