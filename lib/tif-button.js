$(document).ready(function() {
	domainRules = [
		...
		},
		{
			...
			//selector: '[id^="enabledAddToBasket_"]',
			selector: '.tableitemQty',
	...
	jQuery(getRule(hostName)).after('<input id="tif-button" type="button" /><div class="chartTitle">Trackif Price Chart</div><a href="'+getLink(hostName)+'"><div class="tif-chart-wrapper"><canvas id="canvas" height="160px" width="200px"></canvas></div></a>');


	$("#tif-button").click(function() {
		// used to not make the panel slide down
		$(".tif-chart-wrapper, .arrow, .chartTitle").slideToggle(1);			
		});
...
/*
	...
	*/
	...
	$('.tif-chart-wrapper, .arrow, .chartTitle').css('display', 'none');
});
