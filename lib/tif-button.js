$(document).ready(function() {
	...
	jQuery(getRule(hostName)).after('<input id="tif-button" type="button" /><div class="chartTitle">Trackif Price Chart</div><a id="tif-chart-container" href="'+getLink(hostName)+'"><div class="tif-chart-wrapper"><canvas id="canvas" height="160px" width="200px"></canvas></div></a>');
